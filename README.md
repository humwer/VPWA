...
Проект экзамена по базовым навыкам проведения тестирования на проникновение веб-приложения.

<details>
<summary>В экзамене присутствуют следующие уязвимости:</summary>
